...
```
./gradlew -Pcontentpath=HelloWorld/UnitedStates/English build
```
...
```
./gradlew -Ptitle="Hello Globe" build
```
...
```
./gradlew -Prootsegment=hello build
```

```
./gradlew -Pshorttitle=hello build
```
